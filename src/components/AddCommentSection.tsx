...
export const AddCommentSection = () => {
  ...
  if (isMobile) {
    return (
      <div className="bg-white mt-10 flex-initial h-50 rounded-md flex flex-col gap-4 p-4">
        <textarea
        ...
        <div className="flex flex-row justify-between">
          ...
          <button className="bg-(--purple-600) border rounded-md h-12 px-6 text-white cursor-pointer">
            SEND
          </button>
        </div>
      </div>
  ...
  return (
    <div className="bg-white mt-10 flex-initial h-40 rounded-md flex flex-row gap-4 p-6">
      ...
      <textarea
        ...
        placeholder="Add a comment..."
      ></textarea>
      <button className="bg-(--purple-600) border rounded-md h-10 px-6 text-white cursor-pointer">
        SEND
      </button>
    </div>
  );
